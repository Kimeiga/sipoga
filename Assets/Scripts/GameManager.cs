...
//    private List<Vector3> availableWaypoints;
//    
//    
//}
...
public class KdTree<T> : IEnumerable<T>, IEnumerable where T : Component
{
    ...
    public T FindClosestWithCondition(Vector3 position, Predicate<T> match)
    {
        return _findClosestWithCondition(position, match);
    }
...
protected T _findClosestWithCondition(Vector3 position, Predicate<T> match)
    {
        if (_root == null)
            return null;
        ...
        while (openCur < _open.Length && _open[openCur] != null)
        {
            ...
            var nodeDist = _distance(position, current.component.transform.position);
            if (nodeDist < nearestDist && match(current.component)) // my only modified line
            {
                nearestDist = nodeDist;
                nearest = current;
            }
...
//    public GameObject[] canaTeam;
//    public GameObject[] yenaTeam;
...
//    DontDestroyOnLoad(gameObject);
    ...
    void Start()
    {
////        List<Player> originalYena = new List<Player>();
//        foreach (GameObject yena in GameObject.FindGameObjectsWithTag("Yena"))
//        {
////            originalYena.Add(yena.GetComponent<Player>());
//            yenaTeam.Add(yena.GetComponent<Player>());
//        }
////        print(originalYena.Count());
//        
////        yenaTeam.AddAll(originalYena);
//        
////        List<Player> originalCana = new List<Player>();
//        foreach (GameObject cana in GameObject.FindGameObjectsWithTag("Cana"))
//        {
////            originalCana.Add(cana.GetComponent<Player>());
//        
